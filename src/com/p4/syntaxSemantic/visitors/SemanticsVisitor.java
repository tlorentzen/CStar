...
public class SemanticsVisitor implements INodeVisitor {
    ...
    public void visit(IdNode node){
        ...
        if(symbolTable.calledFunctions.contains(node.getId()) && !symbolTable.declaredFunctions.contains(node.getId())){
            ...
            if(attributes == null){
                errors.addEntry(ErrorType.TYPE_ERROR, "'" + node.getId() + "' has not been declared in any accessible scope. " +
                                                                "The type of '" + node.getId() + "' will be null", node.lineNumber);
    ...
    private String assignFuncCall(AssignNode node, String leftType){
        ...
        //Returns error if the function id of the void type
            ...
            errors.addEntry(ErrorType.VOID_ASSIGN, "Cannot assign function '" + ((IdNode) funcCallNode.children.get(0)).getId() + "' to "
    ...
    public void visit(CondNode node){
        ...
        isValidType = compareOperationValid(node.getToken(), leftType, rightType);
