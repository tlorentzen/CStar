...
public class CStarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements CStarVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitTest_mult_val(CStarParser.Test_mult_valContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitInclude(CStarParser.IncludeContext ctx) { return visitChildren(ctx); }
}
